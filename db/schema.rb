...
ActiveRecord::Schema[7.0].define(version: 2022_07_12_212631) do
  ...
  create_table "user_applications", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
